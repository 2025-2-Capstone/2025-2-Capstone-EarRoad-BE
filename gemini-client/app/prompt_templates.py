...
다음 스크립트를 들으면서 천천히 다음 목적지로 이동해주세요.
...
스크립트는 **6~7분 동안 읽을 수 있는 길이**로 구성하며,
자연스럽고 부드러운 흐름을 가진 설명형 스토리텔링으로 작성해주세요.
문단을 적절히 나누고, 들었을 때 편안하게 이해할 수 있도록 구성해주세요.
"""

def long_visual_guide_prompt(place: str, overview: str):
...
def short_visual_guide_prompt(place: str, overview: str):
